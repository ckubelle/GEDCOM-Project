...
class TestUserStory11(unittest.TestCase):
    ...
    def test_check_Bigamy(self):
        ...
        self.assertTrue(user_story_11.checkBigamy(self.test_indi, self.test_famlist, self.test_husb))
        self.assertTrue(user_story_11.checkBigamy(self.test_indi, self.test_famlist, self.test_wife))
